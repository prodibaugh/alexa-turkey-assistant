 // 1. Text strings =====================================================================================================
  ...
  const languageStrings = {
      'en': {
          'translation': {
              'WELCOME' : "Welcome to the Thanksgiving Turkey Recipe skill. ",
              'TITLE'   : "How to Cook a Turkey",
              'HELP'    : "This skill will show you how to cook a Turkey.  You can ask for the list of ingredients, or just say begin cooking if you are ready. Once you are cooking, just say Next to advance to the next step in the recipe. You can also pause the recipe at any time by saying Pause.",
  ...
  const data = {
    // TODO: Replace this data with your own.
      "ingredients" :
          [
              {"name": "this",  "qty": 1, "units": "little of"},
              {"name": "that",  "qty": 1, "units": "little of"},
              {"name": "something",  "qty": 1, "units": "lots of"}
              //{"name": "Butter",    "qty": 4, "units": "tablespoons"  },
              //{"name": "Salt", "qty": 1, "units": "tablespoon" }
          ],
      "steps" :
      [
          "Help me program how to cook the bird!"
      ]
  };
